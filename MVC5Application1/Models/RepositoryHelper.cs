namespace MVC5Application1.Models
{
	public static class RepositoryHelper
	{
		...
		public static vw_CustomerRepository Getvw_CustomerRepository()
		{
			var repository = new vw_CustomerRepository();
			repository.UnitOfWork = GetUnitOfWork();
			return repository;
		}

		public static vw_CustomerRepository Getvw_CustomerRepository(IUnitOfWork unitOfWork)
		{
			var repository = new vw_CustomerRepository();
